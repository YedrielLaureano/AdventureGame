...
public class AdventureGame
{
    ...
    {
        string[] validInputs = {GO_NORTH, GO_SOUTH, GO_EAST, GO_SOUTH, GET_LAMP, GET_KEY, OPEN_CHEST, QUIT};
    ...
    private void ProcessInput(string input)
    {
        ...
        {
            Console.WriteLine("Yuo got eaten alive by the Grue!");
